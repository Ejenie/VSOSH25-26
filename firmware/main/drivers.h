...
#define constRail 1.6     //константа для пересчета шагов двигателя в миллиметры для езды по рейке
#define constPlotter 5.0  //константа для пересчета шагов двигателя в миллиметры для езды внетри плоттера
