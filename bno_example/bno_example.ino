...
void plotEuler(double *data) {  // Функция для вывода в Serial Plotter углов Эйлера
  ...
  Serial.println(data[2]);  // В конце обязательно println*/
}
...
void loop() {
  readBNOData(a);  // Вызов функции чтения

  plotEuler(a);  // Функция для вывода в Serial Plotter углов Эйлера
